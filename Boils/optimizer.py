...
from Boils.localbo_cat import CASMOPOLITANCat
from Boils.localbo_utils import from_unit_cube, latin_hypercube, onehot2ordinal, \
...
class Optimizer:
    ...
    def restart(self):
        from Boils.localbo_utils import train_gp
