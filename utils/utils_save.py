...
_aux_path = os.path.join(ROOT_PROJECT, 'results_storage_root_path.txt')
try:
    f_ = open(_aux_path, "r")
...
def get_storage_root():
    return os.path.join(DATA_STORAGE_ROOT,'results')


def get_storage_models_root():
    return os.path.join(DATA_STORAGE_ROOT, PROJECT_NAME, 'models')
...
def get_storage_data_root():
    return os.path.join(DATA_STORAGE_ROOT,'data')
